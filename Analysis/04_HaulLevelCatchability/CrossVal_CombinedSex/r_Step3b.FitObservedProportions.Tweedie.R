#--fit various models for obsR using mgcv to fit GAMs for combined sexes using the TWEEDIE distribution----
require(DHARMa);
require(dplyr);
require(ggplot2);
require(gratia)
...
#--run cross validation-------------------------------------------------
  ...
  ##--Make sure to move these to "ModelResults_TweedieModels" subfolder before further processing.
}
if (FALSE){
