...
calcStep4<-function(){
  ...
  p = ggplotify::as.ggplot(~DHARMa::plotQQunif(simRes),envir=current_env());#--need to add current environment!
  ...
  p = ggplotify::as.ggplot(~DHARMa::plotResiduals(simRes),envir=current_env());#--need to add current environment!
