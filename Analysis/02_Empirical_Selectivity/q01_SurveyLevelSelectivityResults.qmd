...
#| fig-cap: "Comparison of annual empirical estimates of NMFS survey selectivity for BBRKC. An overall (unweighted) smoothed trend and simple uncertainty interval are indicated by the thick blue line and grey shading."
#| fig-asp: 0.6
...
#| results: asis
#| fig-cap: "Estimated selectivity for arbitrary years, $S(z)$, from the model regarded as the most satisfactory, Model 3."
#| fig-width: 9
#| fig-asp: 0.6
  dfr = dplyr::bind_rows(
          prd3mt
  )
  p1 = ggplot(dfr,aes(x=z,y=emp_sel,ymin=lci,ymax=uci)) +
        geom_line() + geom_ribbon(alpha=0.3) + 
        ylim(c(0,NA)) + 
