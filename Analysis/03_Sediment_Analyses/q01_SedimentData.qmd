...
### Sediment data {#sec-SedData}

Sediment characteristics may influence the vulnerability of Tanner crab to capture in the NMFS survey gear by affecting a crab's ability to bury in the sediment or by affecting the bottom-tending dynamics of the survey gear [@WeinbergAndKotwicki2008; @SomertonAndOtto1999; @SomertonEtAl2013]. The EBS shelf is characterized by large areas with reasonably homogeneous sediments due to its relatively broad, shallow shelf and the unusually small slope of its bottom [@EBSSED2]. Various grades of sand predominate overall, although significant concentrations of mud occur at greater-than-average depths. Gravel is rare and generally confined to nearshore areas. Because sediment characteristics vary spatially across the EBS, we interpolated point measurements reflecting mean grain size (in $\varphi$ units, i.e., negative log_2 of the diameter in mm) and sorting coefficient (reflecting the variance in grain size) at locations across the EBS from high resolution samples in the EBSSED-2 sediment database [@EBSSED2] to NMFS survey haul locations using the co-kriging geostatistics function of ArcGIS [@REF] to include as potential covariates in the SBS selectivity analysis for Tanner crab.
